    ...
    <body>
        ...
        <section id="produtoNovo">
            ...
            <div class="container border border-dark rounded shadow p-5">
                <form action="CategoriaServlet?action=novo" method="post">

                    <h3 class="text-center"><i class="fa fa-plus"></i> Nova Categoria</h3>

                    <div class="form-row mb-3">
                        <div class="form-group col-md-6 offset-md-3">
                            <label for="input-categoria"><i class="fa fa-clipboard-list"></i> Categoria:</label>
                            <input type="text" name="categoria" class="form-control bg-transparent border-dark"
                                   id="input-tipo" maxlength="255" required>
                        </div>
                    </div>

                    <button type="submit" class="btn btn-dark col-md-6 offset-md-3">Salvar <i class="fa fa-check"></i></button>
