    ...
    <body>
        ...
        <section id="produtoNovo">
            ...
            <div class="container border border-dark rounded shadow p-5">
                <form action="ProdutoServlet?action=novo" method="post">

                    <h3 class="text-center"><i class="fa fa-plus"></i> Novo Produto</h3>

                    <div class="form-row mb-3">
                        <div class="form-group col-md-6 offset-md-3">
                            <label for="input-produto"><i class="fa fa-cube"></i> Produto:</label>
                            <input type="text" name="produto" class="form-control bg-transparent border-dark"
