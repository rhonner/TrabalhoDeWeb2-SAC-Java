    ...
    <body>
        ...
        <section id="detalhes">
            ...
            <div class="container border border-dark rounded shadow p-5">
                ...
                <h3 class="text-center"><i class="fa fa-eye"></i> Detalhes da Categoria</h3>
                <div class="row p-3">

                    <div class="col-md-2">
                        <h6>
                            <i class="fa fa-hashtag"></i><b> ID: </b>${categoria.id}
                        </h6>
                    </div>              
                    <div class="col-md-10">
                        <h6>
                            <i class="fa fa-clipboard-list"></i><b> Categoria: </b>${categoria.nome}
                        </h6>
                    </div>              
