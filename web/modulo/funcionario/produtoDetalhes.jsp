    ...
    <body>
        ...
        <section id="detalhes">
            ...
            <div class="container border border-dark rounded shadow p-5">
                ...
                <h3 class="text-center"><i class="fa fa-eye"></i> Detalhes do Produto</h3>
                <div class="row p-3">

                    <div class="col-md-2">
                        <h6>
                            <i class="fa fa-hashtag"></i><b> ID: </b>${produto.id}
                        </h6>
                    </div>                  
                    <div class="col-md-5">
                        <h6>
                            <i class="fa fa-cube"></i><b> Produto: </b>${produto.nome}
                        </h6>
                    </div>                  
                    <div class="col-md-5">
                        <h6>
                            <i class="fa fa-clipboard-list"></i><b> Categoria: </b>${produto.categoria.nome}
                        </h6>
                    </div>              
