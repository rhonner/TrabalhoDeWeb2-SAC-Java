    ...
    <body>
        ...
        <section id="produtoNovo">
            ...
            <div class="container border border-dark rounded shadow p-5">
                <form action="CategoriaServlet?action=alterarCategoria" method="post">

                    <h3 class="text-center"><i class="fa fa-edit"></i> Alterar Categoria</h3>

                    <div class="form-row mb-3">
                        <input type="hidden" name="id" value="${categoria.id}">
                        <div class="form-group col-md-6 offset-md-3">
                            <label for="input-categoria"><i class="fa fa-clipboard-list"></i> Categoria:</label>
                            <input type="text" name="categoria" value="${categoria.nome}" class="form-control bg-transparent border-dark"
                                   id="input-categoria" maxlength="50" required>
                        </div>
                    </div>
